...
pub mod proxy {
    ...
    impl ZAP {
        ...
        async fn continue_from_break(&self) -> Result<(), Box<dyn Error>> {
        ...
        pub async fn add_break(&self) -> Result<(), Box<dyn Error>> {
        ...
        pub async fn remove_break(&self) -> Result<(), Box<dyn Error>> {
        ...
        pub async fn get_http(&self) -> Result<HTTP, Box<dyn Error>> {
        ...
        pub async fn inject_sql(&self, req: &HTTP, param: &str, cmd: &str) -> Result<(), Box<dyn Error>> {
